module Refinery
  module Members
    class Item < Refinery::Core::BaseModel
      ...
      translates :name, :slug, :post, :address, :room, :studies, :languages, :actual_education, :education, :research, :conferences, :publications, :awards
      ...
      attr_accessible :name, :post, :position, :avatar_id, :group_id, :user_id,
        ...
        :studies, :languages, :actual_education, :education, :research, :conferences, :publications, :awards
